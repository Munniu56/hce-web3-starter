# BẰNG CHỨNG NỘP BÀI THỰC HÀNH - LAB 3 (forensics.md)
...
**Sản phẩm nộp quy định:** `forensics.md`  
...
## 2. Bước 1 — Mổ xẻ giao dịch của chính mình (Bảng 10 trường dữ liệu Etherscan)

Dưới đây là bảng trích xuất chi tiết 10 trường thông tin trực tiếp từ giao dịch [`0x199e95f10417bb93a1b81ddad2450e0ac4104af985f7a09910eb7506a1cf98a3`](https://sepolia.etherscan.io/tx/0x199e95f10417bb93a1b81ddad2450e0ac4104af985f7a09910eb7506a1cf98a3) trên mạng Sepolia Etherscan:

| STT | Trường dữ liệu | Giá trị thực tế trên Etherscan | Ý nghĩa kỹ thuật | Vì sao người làm nghiệp vụ cần (Ý nghĩa kinh tế & Tuân thủ) |
| :--- | :--- | :--- | :--- | :--- |
...
### 3.1. Phân biệt kiến trúc Hợp đồng thông thường và Hợp đồng Proxy (EIP-1967)
